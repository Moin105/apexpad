 ...
 {show ?   <div className='top'>
    ...
    <header>
        ...
        <nav className='desktop-fide'>
            ...
            {/* <Dropdown text="" options={[{name:"Soon",cname:"pisco"}]} /> */}
            <Dropdown text="Lockers" options={[{name:"Solana",link:"https://app.apexpad.finance/sol/locker"}, {name:"Injective",link:"https://app.apexpad.finance/inj/locker"},{ name:"Near",link:'https://app.apexpad.finance/near/locker'},{name:"Sei",link:'https://app.apexpad.finance/sei/locker'}]} />
